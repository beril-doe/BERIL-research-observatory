...
($\beta = -0.033$, $p = 5.2 \times 10^{-9}$), while resistance and detoxification KOs (106 KOs)
...
KOs (Tl, Fe, Ni, Zn, Al, Co, S, Cu, Mn), sorted by $\beta$. BH-FDR $q < 0.05$
indicated by filled points. Effect sizes are uniform across chemically diverse
metals, indicating a general metal-ecology association rather than a single-metal
artefact.}
\label{fig:2}
\end{figure*}
...
opposite profile: a cross-biome niche-breadth association equal in magnitude
