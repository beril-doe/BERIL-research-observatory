...
suggesting chromosomal HGT for this gold-sensing regulator. Published surveys confirm that
the majority of double-signal genes---mercury resistance (\textit{merD}, \textit{merE}),
arsenite oxidase (\textit{aoxB}), and related resistance determinants---are predominantly
found on plasmids, transposons, and integrative/conjugative elements
